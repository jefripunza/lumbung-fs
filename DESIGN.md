# LumbungFS Dashboard Design Prompt

Design a premium self-hosted object storage management platform called "LumbungFS".

The visual style is inspired by startup strategy presentations, operating system maps, architectural planning boards, and modern SaaS dashboards.

Do not design it as a traditional file explorer.

Do not imitate Windows Explorer, Google Drive, or Dropbox.

The interface should feel like an infrastructure control center where administrators manage domains, storage buckets, access rules, and traffic flows.
...
- Strategic planning board aesthetic
- Rounded cards
- Large spacing
- Premium typography
- Soft shadows
- Green monochromatic accents
...
The dashboard should feel like a visual representation of the system architecture itself.

---

## Dashboard Philosophy

The entire UI should visualize the request lifecycle.

Origin → Rule Validation → Storage Bucket → File Access

Everything in the interface should reinforce this concept.

Users should instantly understand:

- Which domains are connected
- Which rules protect them
- Which buckets belong to them
...
The homepage is not a file explorer.

Instead, display a visual architecture map.

Center Area:

A large architecture canvas showing:
...
Connected using animated lines.

Each node is represented as a premium card.
...
JWT Validation
↓
bucket/domain1_com/user/ktp

Animated request flow indicators move between nodes.
...
Include subtle line charts.

Include animated trend indicators.

---

## Origin Management

Represent origins as visual infrastructure nodes.

Each origin card contains:
...
Cards are displayed inside a network-style grid.

Blocked origins visually appear disconnected.

Unknown origins appear in warning colors.

---

## Rules Management

Rules are displayed as validation pipelines.
...
Each rule appears as a horizontal flow diagram.
...
This is the only area that behaves like a file manager.

However it should still maintain the strategic visual style.
...
Folders appear as large rounded containers.

Files appear as compact cards.

Breadcrumbs remain visible at all times.
...
Display unknown domains as incoming requests attempting access.

Visualize them as floating nodes entering the system.
...
Display request flows in real time.
...
Animated dots travel through the pipeline.

Failed requests stop at the corresponding validation stage.

Blocked requests appear in red.

Successful requests appear in green.

---

## Login Screen

The login page should feel like accessing an infrastructure control center.

Center card layout.

Large LumbungFS logo.

Minimalist form.

Background contains subtle architecture diagrams and request-flow sketches.
...
Display architectural placeholders.

Examples:

"No Origins Registered"

Show a visual flow diagram explaining:
...
Never use boring empty states.

---

## User Experience Goal

LumbungFS should feel like:

- Object Storage Control Center
- Infrastructure Dashboard
- Storage Operations Platform
...
Users should feel like they are operating a storage infrastructure platform rather than browsing files.
...
:root {
  ...
  --font-denim:
    "denim", ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont,
    "Segoe UI", Roboto, sans-serif;
  --font-muoto:
    "muoto", ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont,
    "Segoe UI", Roboto, sans-serif;
  --font-cinetype:
    "cinetype", ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont,
    "Segoe UI", Roboto, sans-serif;
  ...
  /* Shadows */
  --shadow-sm:
    rgba(9, 53, 45, 0.05) 0px 5px 6px -4px,
    rgba(174, 202, 197, 0.08) 0px 1px 1px 0.5px;
  ...
  --shadow-md:
    rgba(8, 18, 17, 0.01) 0px 0px 16px -1px,
    rgba(8, 18, 17, 0.04) 0px 0px 5.5px -0.5px;
  --shadow-sm-2: rgba(0, 0, 0, 0.25) 0px 5px 5px 0px;
  --shadow-sm-3: rgba(0, 0, 0, 0.1) 0px 5px 7.5px -5px;
  --shadow-md-2:
    rgba(8, 18, 17, 0.01) 0px 0px 16px -1px,
    rgba(8, 18, 17, 0.04) 0px 0px 5.5px -0.5px,
    rgb(224, 229, 229) 0px 0px 0px 0.5px inset;
